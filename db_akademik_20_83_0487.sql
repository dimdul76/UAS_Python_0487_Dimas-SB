...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 26, 2022 at 06:31 AM
...
--
-- Table structure for table `tbl_students_0487`
--

CREATE TABLE `tbl_students_0487` (
  `id` int(100) NOT NULL,
  `nim` text NOT NULL,
  `nama` text NOT NULL,
  `jk` text NOT NULL,
...
--
-- Dumping data for table `tbl_students_0487`
--

INSERT INTO `tbl_students_0487` (`id`, `nim`, `nama`, `jk`, `jurusan`, `alamat`) VALUES
...
--
-- Indexes for table `tbl_students_0487`
--
ALTER TABLE `tbl_students_0487`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `tbl_students_0487`
--
ALTER TABLE `tbl_students_0487`
